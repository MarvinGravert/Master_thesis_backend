...
class ServerState():
    def __init__(self):
        ...
        """)
        self.LH2Robo = Calibration(""" 0.7979598   0.00634214 -0.60267729 -2.92676831
                                    -0.60261786 -0.0091491  -0.79797745 -2.51989966
                                    -0.01057484  0.99993801 -0.00347873 1.30218701      
                                    0.          0.          0.          1.       """)
