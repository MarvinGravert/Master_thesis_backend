...
if __name__ == "__main__":
    ...
    while True:
        ...
        # tracker_pose_in_LH = v.devices["tracker_1"].get_pose_quaternion()
        # print(tracker_pose_in_LH)
        # collector.append(tracker_pose_in_LH)
        ...
        collector.append(v.devices["controller_1"].get_pose_quaternion())
        # print(v.devices["controller_1"].get_pose_quaternion())
